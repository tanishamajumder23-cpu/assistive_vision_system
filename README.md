...
Concept Learned: An image is represented as a NumPy array (matrix of numbers). Each pixel contains numerical values. In a color image, each pixel consists of three components: Blue, Green, and Red (BGR).
...
Understanding: Continuous updating of frames creates the appearance of live video.
